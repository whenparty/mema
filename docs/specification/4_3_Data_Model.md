...
| description | Brief contextual descriptor, generated by LLM on entity creation and updated during User Summary rebuild. Example: "son, 4 years old, attends kindergarten in Munich." Used by the compact model to resolve ambiguous mentions |
...
- `{ "type": "entity_disambiguation", "mention": "...", "candidate_entity_ids": ["uuid-1", "uuid-2"], "pending_fact": { ...fact data... } }`: ambiguous entity mention awaiting user clarification. After response — fact is saved with the specified entity, bot responds to the original request
