/**
 * Combined extraction prompt — single LLM call for pipeline steps 4-8
 * Tests the architecture assumption from 4.4 System Architecture
 */
          ...
          items: {
            ...
            properties: {
              ...
              entity_confidence: {
                ...
                enum: ["high", "low"],
                description:
                  "high = one candidate and message context unambiguously points to it (e.g. health fact + child entity). low = multiple equally likely candidates or insufficient context signal to resolve with confidence.",
              },
            },
            required: [
              "mention",
          ...
          items: {
            ...
            properties: {
              ...
              conflict_type: {
                ...
                description:
                  "explicit_update = user declares change. implicit_contradiction = conflicting without declaration. coexistence = both can be true. no_conflict = different aspect, no contradiction.",
              },
              reasoning: {
                type: "string",
                description:
